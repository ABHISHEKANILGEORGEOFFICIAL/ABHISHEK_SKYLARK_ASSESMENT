...
deals_board_id = st.text_input("Deals Board ID", value="5027109850")
workorders_board_id = st.text_input("Work Orders Board ID", value="5027111015")

query = st.text_input("Ask a question", value="How is our pipeline?")
